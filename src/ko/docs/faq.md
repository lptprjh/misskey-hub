...
Misskey 기본 번역 기능은 [DeepL의 번역 서비스](https://www.deepl.com/)를 사용하고 있습니다. (2022년 9월 기준 한국어 미지원)
단, 다른 이용자에 의해 Fork된 버전에서는 다른 번역 서비스를 이용할 가능성이 있습니다. 자세한 내용은 각 인스턴스의 관리자에게 문의해 주십시오.
